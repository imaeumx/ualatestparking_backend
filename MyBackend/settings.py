...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-k=$klu1^tamff9td3_82)9@fvq=bjb*j-9fmgc(&vg@=u_bv)3')
DES_SECRET_KEY = os.environ.get('DES_SECRET_KEY', 'hwBYAEY65bs=')
